...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4 = QtWidgets.QLabel(self.selection_groupBox)
        self.label_4.setMinimumSize(QtCore.QSize(50, 0))
        self.label_4.setObjectName("label_4")
        self.verticalLayout_5.addWidget(self.label_4)
        self.opacity_slider_2 = QtWidgets.QSlider(self.selection_groupBox)
        self.opacity_slider_2.setCursor(QtGui.QCursor(QtCore.Qt.SizeVerCursor))
        self.opacity_slider_2.setAccessibleDescription("")
        self.opacity_slider_2.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.opacity_slider_2.setMaximum(100)
        self.opacity_slider_2.setProperty("value", 100)
        self.opacity_slider_2.setOrientation(QtCore.Qt.Vertical)
        self.opacity_slider_2.setInvertedAppearance(False)
        self.opacity_slider_2.setInvertedControls(False)
        self.opacity_slider_2.setTickPosition(QtWidgets.QSlider.TicksBothSides)
        self.opacity_slider_2.setObjectName("opacity_slider_2")
        self.verticalLayout_5.addWidget(self.opacity_slider_2)
        self.label_5 = QtWidgets.QLabel(self.selection_groupBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Row 0"))
        self.label_5.setText(_translate("MainWindow", "Row 1"))
        ...
        item.setText(_translate("MainWindow", "Xoffset (pixels)"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Yoffset (pixels)"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Rotation (degrees)"))
