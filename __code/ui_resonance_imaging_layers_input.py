...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layer_groupBox = QtGui.QGroupBox(self.centralwidget)
        self.layer_groupBox.setObjectName(_fromUtf8("layer_groupBox"))
        self.verticalLayout = QtGui.QVBoxLayout(self.layer_groupBox)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.example_table = QtGui.QTableWidget(self.layer_groupBox)
        ...
        self.layer_table = QtGui.QTableWidget(self.layer_groupBox)
        ...
        self.label_5 = QtGui.QLabel(self.layer_groupBox)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.horizontalLayout_9.addWidget(self.label_5)
        self.Emin_lineEdit = QtGui.QLineEdit(self.layer_groupBox)
        self.Emin_lineEdit.setMinimumSize(QtCore.QSize(80, 0))
        self.Emin_lineEdit.setMaximumSize(QtCore.QSize(80, 16777215))
        self.Emin_lineEdit.setObjectName(_fromUtf8("Emin_lineEdit"))
        self.horizontalLayout_9.addWidget(self.Emin_lineEdit)
        self.label_8 = QtGui.QLabel(self.layer_groupBox)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.horizontalLayout_9.addWidget(self.label_8)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_9.addItem(spacerItem)
        self.label_9 = QtGui.QLabel(self.layer_groupBox)
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.horizontalLayout_9.addWidget(self.label_9)
        self.Emax_lineEdit = QtGui.QLineEdit(self.layer_groupBox)
        self.Emax_lineEdit.setMinimumSize(QtCore.QSize(80, 0))
        self.Emax_lineEdit.setMaximumSize(QtCore.QSize(80, 16777215))
        self.Emax_lineEdit.setObjectName(_fromUtf8("Emax_lineEdit"))
        self.horizontalLayout_9.addWidget(self.Emax_lineEdit)
        self.label_10 = QtGui.QLabel(self.layer_groupBox)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.horizontalLayout_9.addWidget(self.label_10)
        spacerItem1 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_9.addItem(spacerItem1)
        self.deltaE_label = QtGui.QLabel(self.layer_groupBox)
        self.deltaE_label.setObjectName(_fromUtf8("deltaE_label"))
        self.horizontalLayout_9.addWidget(self.deltaE_label)
        self.deltaE_lineEdit = QtGui.QLineEdit(self.layer_groupBox)
        self.deltaE_lineEdit.setMinimumSize(QtCore.QSize(80, 0))
        self.deltaE_lineEdit.setMaximumSize(QtCore.QSize(80, 16777215))
        self.deltaE_lineEdit.setObjectName(_fromUtf8("deltaE_lineEdit"))
        self.horizontalLayout_9.addWidget(self.deltaE_lineEdit)
        self.label_16 = QtGui.QLabel(self.layer_groupBox)
        ...
        self.validate_table_iinputs = QtGui.QPushButton(self.layer_groupBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.layer_groupBox.setTitle(_translate("MainWindow", "Layers", None))
        ...
        item.setText(_translate("MainWindow", "Density (g/cm3)", None))
        self.label_5.setText(_translate("MainWindow", "Emin", None))
        self.Emin_lineEdit.setText(_translate("MainWindow", "0.001", None))
        self.label_8.setText(_translate("MainWindow", "eV", None))
        self.label_9.setText(_translate("MainWindow", "Emax", None))
        self.Emax_lineEdit.setText(_translate("MainWindow", "300", None))
        self.label_10.setText(_translate("MainWindow", "eV", None))
        self.deltaE_label.setText(_translate("MainWindow", "DE", None))
        self.deltaE_lineEdit.setText(_translate("MainWindow", "0.01", None))
        self.label_16.setText(_translate("MainWindow", "eV", None))
