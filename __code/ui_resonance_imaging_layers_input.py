...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.check_groupBox.setEnabled(False)
        ...
        self.layer_name_radio_button = QtGui.QComboBox(self.check_groupBox)
        self.layer_name_radio_button.setObjectName(_fromUtf8("layer_name_radio_button"))
        self.horizontalLayout_4.addWidget(self.layer_name_radio_button)
        ...
        self.label_9 = QtGui.QLabel(self.check_groupBox)
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.gridLayout.addWidget(self.label_9, 2, 0, 1, 1)
        self.layer_molar_mass = QtGui.QLabel(self.check_groupBox)
        self.layer_molar_mass.setObjectName(_fromUtf8("layer_molar_mass"))
        self.gridLayout.addWidget(self.layer_molar_mass, 2, 1, 1, 1)
        self.label_10 = QtGui.QLabel(self.check_groupBox)
        ...
        self.element_name_radio_button = QtGui.QComboBox(self.check_groupBox)
        self.element_name_radio_button.setObjectName(_fromUtf8("element_name_radio_button"))
        self.horizontalLayout_5.addWidget(self.element_name_radio_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(_translate("MainWindow", "Molar Mass", None))
        self.layer_molar_mass.setText(_translate("MainWindow", "N/A", None))
        self.label_10.setText(_translate("MainWindow", "g/mol", None))
