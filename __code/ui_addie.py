...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.h3_table.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.h3_table.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.h3_table.setItem(0, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.h3_table.setItem(0, 3, item)
        item = QtWidgets.QTableWidgetItem()
        self.h3_table.setItem(0, 4, item)
        item = QtWidgets.QTableWidgetItem()
        self.h3_table.setItem(0, 5, item)
        item = QtWidgets.QTableWidgetItem()
        self.h3_table.setItem(0, 6, item)
        item = QtWidgets.QTableWidgetItem()
        self.h3_table.setItem(0, 7, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        __sortingEnabled = self.h3_table.isSortingEnabled()
        self.h3_table.setSortingEnabled(False)
        item = self.h3_table.item(0, 0)
        item.setText(_translate("MainWindow", "1"))
        item = self.h3_table.item(0, 1)
        item.setText(_translate("MainWindow", "2"))
        item = self.h3_table.item(0, 2)
        item.setText(_translate("MainWindow", "3"))
        item = self.h3_table.item(0, 3)
        item.setText(_translate("MainWindow", "4"))
        item = self.h3_table.item(0, 4)
        item.setText(_translate("MainWindow", "5"))
        item = self.h3_table.item(0, 5)
        item.setText(_translate("MainWindow", "6"))
        item = self.h3_table.item(0, 6)
