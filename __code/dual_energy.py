...
from __code.ui_dual_energy import Ui_MainWindow as UiMainWindow


class DualEnergy(object):
...
class ImageWindow(QMainWindow):
    ...
    def __init__(self, parent=None, display_counts_vs_stack=None):
        ...
        self.setWindowTitle("Select ROI to use in the dual energy calculation")
    ...
    def load_data(self):
        ...
        o_norm.load(folder=working_folder, notebook=False)
