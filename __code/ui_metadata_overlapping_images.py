...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.metadata_table = QtWidgets.QTableWidget(self.tab_2)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.metadata_table.setHorizontalHeaderItem(2, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.metadata_table.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Relative Time (s)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Metadata"))
