...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2 = QtWidgets.QPushButton(self.metadata_groupbox)
        ...
        self.metadata_position_label_4 = QtWidgets.QLabel(self.groupBox)
        self.metadata_position_label_4.setEnabled(False)
        ...
        self.metadata_position_frame_3 = QtWidgets.QFrame(self.groupBox)
        self.metadata_position_frame_3.setEnabled(False)
        ...
        self.metadata_position_y_3 = QtWidgets.QSlider(self.metadata_position_frame_3)
        self.metadata_position_y_3.setGeometry(QtCore.QRect(60, 30, 20, 80))
        self.metadata_position_y_3.setMinimumSize(QtCore.QSize(0, 80))
        self.metadata_position_y_3.setMaximumSize(QtCore.QSize(16777215, 80))
        self.metadata_position_y_3.setProperty("value", 99)
        self.metadata_position_y_3.setOrientation(QtCore.Qt.Vertical)
        self.metadata_position_y_3.setObjectName("metadata_position_y_3")
        self.metadata_position_x_3 = QtWidgets.QSlider(self.metadata_position_frame_3)
        self.metadata_position_x_3.setGeometry(QtCore.QRect(20, 50, 100, 22))
        self.metadata_position_x_3.setMinimumSize(QtCore.QSize(100, 0))
        self.metadata_position_x_3.setMaximumSize(QtCore.QSize(100, 16777215))
        self.metadata_position_x_3.setProperty("value", 0)
        self.metadata_position_x_3.setOrientation(QtCore.Qt.Horizontal)
        self.metadata_position_x_3.setObjectName("metadata_position_x_3")
        ...
        self.pushButton_2.clicked.connect(MainWindow.import_table_pressed)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Import Table ..."))
        ...
        self.checkBox_2.setText(_translate("MainWindow", "Enable Graph"))
