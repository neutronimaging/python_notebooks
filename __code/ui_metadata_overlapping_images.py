...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scale_position_groupbox = QtWidgets.QGroupBox(self.widget)
        self.scale_position_groupbox.setEnabled(False)
        self.scale_position_groupbox.setMinimumSize(QtCore.QSize(100, 120))
        self.scale_position_groupbox.setMaximumSize(QtCore.QSize(100, 120))
        self.scale_position_groupbox.setObjectName("scale_position_groupbox")
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.scale_position_groupbox)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.scale_position_widget = QtWidgets.QWidget(self.scale_position_groupbox)
        self.scale_position_widget.setMinimumSize(QtCore.QSize(70, 70))
        self.scale_position_widget.setMaximumSize(QtCore.QSize(70, 70))
        self.scale_position_widget.setObjectName("scale_position_widget")
        self.horizontalLayout_10.addWidget(self.scale_position_widget)
        self.horizontalLayout_11.addWidget(self.scale_position_groupbox)
        ...
        self.metadata_position_groupbox = QtWidgets.QGroupBox(self.widget)
        self.metadata_position_groupbox.setEnabled(False)
        self.metadata_position_groupbox.setMinimumSize(QtCore.QSize(100, 120))
        self.metadata_position_groupbox.setMaximumSize(QtCore.QSize(100, 120))
        self.metadata_position_groupbox.setObjectName("metadata_position_groupbox")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.metadata_position_groupbox)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.metadata_position_widget = QtWidgets.QWidget(self.metadata_position_groupbox)
        ...
        self.horizontalLayout_13.addWidget(self.metadata_position_groupbox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.scale_position_groupbox.setTitle(_translate("MainWindow", "Position"))
        ...
        self.metadata_position_groupbox.setTitle(_translate("MainWindow", "Position"))
