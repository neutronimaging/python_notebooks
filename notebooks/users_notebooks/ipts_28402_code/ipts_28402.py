...
class IPTS_28402:
    ...
    def extraction_of_profiles(self):
        ...
        self.config["profiles_limit"] = {"top": top_profile, "bottom": bottom_profile}
    ...
    def cylinders_positions(self):
        ...
        def plot(image_index, center, inner_radius, outer_radius):
            ...
            self.config["cylinders_position"] = {
                "center": center,
    ...
    def full_profile_with_only_outer_cylinder_corrected(self):
        ...
        for _profile_index, _profile in enumerate(profiles_attenuation_mode):
            ...
            for x in np.arange(0, outer_radius + 1):
                nbr_pixels = number_of_pixel_at_that_position2(
        ...
        def plot_shape_ring_signal(image_index):
            ...
            layout = go.Layout(
                title="Shape of profiles using calculated outer pixel intensity",
                xaxis=dict(title=""),
                yaxis=dict(title=""),
            )
            ...
            trace = go.Scatter(
                y=new_profile_with_outer_cylinder_removed[image_index],
                mode="markers",
    ...
    def correct_inner_cylinder_geometry(self):
        ...
        for intensity in list_intensity:
            ...
            for _index, x in enumerate(d):
                ...
                number_of_pixels_through_thickness = number_of_pixels_at_that_position1(
                    position=x, radius=new_inner_cylinder_radius
                )
        ...
        def plot_final_inner(image_index):
            ...
            layout = go.Layout(
                title=f"Expected Array of image #{image_index}",
    ...
    def export(self, output_folder):
        ...
        for _index, _image in enumerate(list_images):
            ...
            metadata.append(
                f"# profile range (those horizontal profiles will be combined via mean): top_profile="
