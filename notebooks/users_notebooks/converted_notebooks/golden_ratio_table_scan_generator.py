...
file_name = []
csv_file = [
    f"CG1D:Det:Q1:TIFF1:FilePath,CG1D:Det:Q1:TIFF1:FileName,CG1D:Det:Q1:AcquireTime,{name_of_rotation_stage},CG1D:Scan:IncrementRunNo.PROC,CG1D:Scan:RunNoRestore.PROC,Camera,Camera"
]
