...
class TestFolders:
    ...
    def test_retrieving_metadata(self):
        ...
        value_returned_1 = file.retrieve_metadata_value_from_ascii_file(
            filename=self.ascii_file_name, metadata_name=metadata_value_1
        )
        ...
        value_returned_2 = file.retrieve_metadata_value_from_ascii_file(
            filename=self.ascii_file_name, metadata_name=metadata_value_2
        )
