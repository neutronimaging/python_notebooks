...
from __code.wave_front_dynamics.wave_front_dynamics import (
    WaveFrontDynamics,
    WaveFrontDynamicsUI,
)
...
# + run_control={"frozen": false, "read_only": false}
o_ui = WaveFrontDynamicsUI(
    working_dir=system.System.get_working_dir(), wave_front_dynamics=o_wave
)
o_ui.show()
# -
