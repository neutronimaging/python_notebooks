...
class Interface(QMainWindow):
    ...
    histogram_level = {"reference": [], "target": []}
    pyqtgraph_image_view = {"reference": None, "data": None}
    live_rois_id = {"reference": None, "target": None}
    list_reference = []
    list_target = []

    # the target box will be x and y times the size of the reference box
    target_box_size_coefficient = {"x": 1, "y": 1}
    ...
    def __init__(self, parent=None, o_norm=None, configuration=""):
        ...
        o_initialization = GuiInitialization(parent=self, configuration=configuration)
    ...
    def get_list_files(self, start_index=0, end_index=None):
        ...
        _list = {
            "files": self.list_files[start_index:end_index],
    ...
    def save_roi_changed(self, data_type="reference"):
        ...
        region = roi_id.getArraySlice(np.transpose(image), view.imageItem)
        x0 = region[0][0].start
        x1 = region[0][0].stop
        y0 = region[0][1].start
        y1 = region[0][1].stop
        ...
        for _row in np.arange(nbr_row):
            ...
            if _reference_file == _target_file:
                o_utilities.set_status_of_this_row_to_message(
                    row=_row, message="Reference and target MUST be different files!"
                )
                continue
    ...
    def up_up_button_pressed(self):
        Utilities.button_pressed(ui=self.ui.up_up_button, name="up_up")

    def up_up_button_released(self):
        Utilities.button_released(ui=self.ui.up_up_button, name="up_up")

    def up_button_pressed(self):
        Utilities.button_pressed(ui=self.ui.up_button, name="up")

    def up_button_released(self):
        Utilities.button_released(ui=self.ui.up_button, name="up")

    def left_button_pressed(self):
        Utilities.button_pressed(ui=self.ui.left_button, name="left")

    def left_button_released(self):
        Utilities.button_released(ui=self.ui.left_button, name="left")

    def right_button_pressed(self):
        Utilities.button_pressed(ui=self.ui.right_button, name="right")

    def right_button_released(self):
        Utilities.button_released(ui=self.ui.right_button, name="right")

    def left_left_button_pressed(self):
        Utilities.button_pressed(ui=self.ui.left_left_button, name="left_left")

    def left_left_button_released(self):
        Utilities.button_released(ui=self.ui.left_left_button, name="left_left")

    def right_right_button_pressed(self):
        Utilities.button_pressed(ui=self.ui.right_right_button, name="right_right")

    def right_right_button_released(self):
        Utilities.button_released(ui=self.ui.right_right_button, name="right_right")

    def down_button_pressed(self):
        Utilities.button_pressed(ui=self.ui.down_button, name="down")

    def down_button_released(self):
        Utilities.button_released(ui=self.ui.down_button, name="down")

    def down_down_button_pressed(self):
        Utilities.button_pressed(ui=self.ui.down_down_button, name="down_down")

    def down_down_button_released(self):
        Utilities.button_released(ui=self.ui.down_down_button, name="down_down")
