...
class CreateExportTimeStamp(FileFolderBrowser):
    ...
    def output_select_dsc_folder(self, folder):
        ...
        display(
            HTML('<span style="font-size: 20px; color:blue">You have selected the DSC folder: ' + folder + "</span>")
        )
    ...
    def output_select_tiff_folder(self, folder):
        ...
        display(
            HTML('<span style="font-size: 20px; color:blue">You have selected the TIFF folder: ' + folder + "</span>")
        )
