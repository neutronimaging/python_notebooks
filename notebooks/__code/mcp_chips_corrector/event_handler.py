...
class EventHandler:
    ...
    def mcp_alignment_correction(self):
        ...
        if self.parent.ui.apply_chips_alignment_correction.isChecked():
            ...
            o_align = Alignment(parent=self.parent, raw_image=setup_image)
    ...
    def profile_type_changed(self):
        ...
        profile_ui = pg.ROI([x0, y0], [width, height], scaleSnap=True, pen=pen)
    ...
    def profile_changed(self):
        ...
        profile_type = self.o_get.get_profile_type()
        self.parent.profile[profile_type] = {
            "x0": x_y_width_height["x"],
    ...
    def calculate_coefficient_corrector(self):
        if self.y_axis_other_chip is None:
            ...
            coefficient_corrector_s = f"{coefficient_corrector:.2f}"
