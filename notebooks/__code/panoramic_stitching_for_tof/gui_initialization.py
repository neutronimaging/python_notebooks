...
class GuiInitialization:
    ...
    def block_signals(self, status):
        list_ui = [self.parent.ui.list_folders_combobox, self.parent.ui.tableWidget]
        for _ui in list_ui:
    ...
    def matplotlib(self):
        ...
        self.parent.horizontal_profile_plot = _matplotlib(
            parent=self.parent, widget=self.parent.ui.horizontal_profile_plot_widget
        )
        self.parent.vertical_profile_plot = _matplotlib(
            parent=self.parent, widget=self.parent.ui.vertical_profile_plot_widget
        )
