...
class ExportTable:
    ...
    def create_metadata_array(self):
        ...
        metadata.append("# column 0: file index")
        metadata.append("# column 1: file name")

        index_metadata_1 = self.parent.metadata_operation[2]["index_of_metadata"]
        if index_metadata_1 == -1:
            metadata.append("# column 2: No metadata selected!")
        else:
        ...
        if index_metadata_2 == -1:
            metadata.append("# column 3: No metadata selected!")
        else:
