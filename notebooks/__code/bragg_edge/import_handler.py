...
from __code.bragg_edge.fitting_functions import kropff_bragg_peak_tof, kropff_high_lambda, kropff_low_lambda
...
class ImportHandler:
    ...
    def run(self):
        ...
        ascii_file = QFileDialog.getOpenFileName(
            self.parent, caption="Select ASCII file", directory=working_dir, filter="ASCII (*.txt)"
        )
        ...
        if ascii_file[0]:
            ...
            self.parent.ui.statusbar.showMessage(f"{ascii_file[0]} has been imported!", 10000)  # 10s
    ...
    def create_fitting_input_dictionary_from_imported_ascii_file(self, result_of_import):
        ...
        lda_array_of_peak_selected = lambda_array[self.parent.bragg_edge_range[0] : self.parent.bragg_edge_range[1]]
        ...
        for col in np.arange(3, len(columns_roi) + 3):
            ...
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["kropff"]["high"]["a0"] = columns_roi[
                str_col
            ]["kropff"]["a0"]
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["kropff"]["high"]["b0"] = columns_roi[
                str_col
            ]["kropff"]["b0"]
            ...
            xaxis_to_fit = lda_array_of_peak_selected[
                self.parent.kropff_fitting_range["high"][0] : self.parent.kropff_fitting_range["high"][1]
            ]
            ...
            # low lambda
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["kropff"]["low"]["ahkl"] = columns_roi[
                str_col
            ]["kropff"]["ahkl"]
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["kropff"]["low"]["bhkl"] = columns_roi[
                str_col
            ]["kropff"]["bhkl"]
            ...
            xaxis_to_fit = lda_array_of_peak_selected[
                self.parent.kropff_fitting_range["low"][0] : self.parent.kropff_fitting_range["low"][1]
            ]
            ...
            yaxis_fitted = kropff_low_lambda(xaxis_to_fit, kropff_a0, kropff_b0, kropff_ahkl, kropff_bhkl)
            ...
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["kropff"]["bragg_peak"][
                "ldahkl_error"
            ...
            yaxis_fitted = kropff_bragg_peak_tof(
                xaxis_to_fit, kropff_a0, kropff_b0, kropff_ahkl, kropff_bhkl, kropff_ldahkl, kropff_sigma, kropff_tau
            )
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["kropff"]["bragg_peak"][
                "yaxis_fitted"
            ] = yaxis_fitted
            ...
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["march_dollase"]["sigma"] = columns_roi[
                str_col
            ]["march_dollase"]["sigma"]
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["march_dollase"]["alpha"] = columns_roi[
                str_col
            ]["march_dollase"]["alpha"]
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["march_dollase"]["a1"] = columns_roi[
                str_col
            ]["march_dollase"]["a1"]
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["march_dollase"]["a2"] = columns_roi[
                str_col
            ]["march_dollase"]["a2"]
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["march_dollase"]["a5"] = columns_roi[
                str_col
            ]["march_dollase"]["a5"]
            self.parent.fitting_input_dictionary["rois"][col_index]["fitting"]["march_dollase"]["a6"] = columns_roi[
                str_col
            ]["march_dollase"]["a6"]
        ...
        self.parent.fitting_input_dictionary["bragg_edge_range_selected"] = result_of_import["metadata"][
            "bragg_edge_range"
        ]
