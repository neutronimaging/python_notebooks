...
class Get(TopGet):
    def __init__(self, parent=None):
        ...
        self.x_axis_choice_ui = {
            "selection": {
                "index": self.parent.ui.selection_index_radiobutton,
                "tof": self.parent.ui.selection_tof_radiobutton,
                "lambda": self.parent.ui.selection_lambda_radiobutton,
            },
            "fitting": {
                "index": self.parent.ui.fitting_index_radiobutton,
    ...
    def all_x_axis(self):
        all_x_axis = {
            "index": self.specified_x_axis(xaxis="index"),
