...
from __code.bragg_edge.fitting_functions import march_dollase_advanced_fit, march_dollase_basic_fit
...
class MarchDollaseFittingJobHandler:
    ...
    def isolate_left_center_right_axis(self, row=-1):
        ...
        [global_left_index, global_right_index] = [int(bragg_edge_range[0]), int(bragg_edge_range[1])]
        ...
        return {
            "left_part": {"lambda_x_axis": lambda_x_axis[0:left_index], "y_axis": y_axis[0:left_index]},
            "center_part": {
                "lambda_x_axis": lambda_x_axis[left_index:right_index],
                "y_axis": y_axis[left_index:right_index],
            },
            "right_part": {"lambda_x_axis": lambda_x_axis[right_index:], "y_axis": y_axis[right_index:]},
        }
    ...
    def prepare(self):
        ...
        def set_params(params_object, name_of_parameter, dict_entry, parameter_flag):
            params_object.add(name_of_parameter, value=float(dict_entry[name_of_parameter]), vary=parameter_flag)
        ...
        for _roi_row in np.arange(nbr_roi_row):
            ...
            for _history_row, _row_entry in enumerate(march_dollase_fitting_history_table):
                ...
                [d_spacing_flag, sigma_flag, alpha_flag, a1_flag, a2_flag, a5_flag, a6_flag] = _row_entry
