...
class RotateAndCropImages(QMainWindow):
    ...
    def display_crop_region(self):
        ...
        roi = pg.ROI([x0, y0], [width, height], pen=(209, 230, 27), scaleSnap=True)
    ...
    def rotate_and_crop_all(self):
        ...
        for file_index in self.data_dict.keys():
            ...
            if float(_rotation_value) != 0.0:
                rotated_data = scipy.ndimage.interpolation.rotate(data, _rotation_value)
...
class Export:
    ...
    def export(self, output_folder):
        new_folder = f"rotated_{self.rotation_angle}deg"
