    ...
    def create_panoramic_images(self, output_folder=None):
        ...
        for _group_index, _group_name in enumerate(data_dictionary.keys()):
            ...
            self.parent.ui.statusbar.showMessage(
                f"Creating panoramic image of {_group_name} using algo. {self.parent.stitching_algorithm} in progress..."
            )
            QtGui.QGuiApplication.processEvents()
...
class SelectStitchingAlgorithm(QDialog):
    ...
    def init_widgets(self):
        ...
        # minimum pyqtgraph
        self.ui.minimum_image_view = pg.ImageView(view=pg.PlotItem(), name="minimum")
        ...
        # maximum pyqtgraph
        self.ui.maximum_image_view = pg.ImageView(view=pg.PlotItem(), name="maximum")
        ...
        # minimum pyqtgraph
        self.ui.mean_image_view = pg.ImageView(view=pg.PlotItem(), name="mean")
