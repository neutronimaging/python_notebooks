class GuiHandler:
    ...
    def enabled_vertical_profile_widgets(self, enabled):
        list_verti_ui = [
            self.parent.ui.vertical_profile_plot_widget,
            self.parent.ui.vertical_profile_width_slider,
            self.parent.ui.vertical_profile_label,
        ]
    ...
    def enabled_horizontal_profile_widgets(self, enabled):
        list_hori_ui = [
            self.parent.ui.horizontal_profile_plot_widget,
            self.parent.ui.horizontal_profile_width_slider,
            self.parent.ui.horizontal_profile_label,
        ]
