...
class ConfigurationHandler:
    ...
    def load(self):
        ...
        if config_file_name[0]:
            ...
            message = f"{os.path.basename(config_file_name[0])} ... Loaded!"
    ...
    def save(self):
        ...
        if config_file_name[0]:
            ...
            message = f"{os.path.basename(config_file_name[0])} ... Saved!"
            self.parent.ui.statusbar.showMessage(message, 10000)  # 10s
            self.parent.ui.statusbar.setStyleSheet("color: green")
    ...
    def get_config_dict(self):
        ...
        config_dict = {
            "ring": {
                "central_pixel": {"x": x_central_pixel, "y": y_central_pixel},
                "radius": ring_radius,
                "thickness": ring_thickness,
            },
            "angle_bin_size": angle_bin_size,
            "grid": {"bin_size": bin_size, "red": red, "green": green, "blue": blue, "alpha": alpha},
        }
