...
class FromJsonToCsv:
    ...
    def select_images(self):
        _instruction = "Select files to convert"
    ...
    def __bin_parameter_changed(self, sender):
        ...
        self.right_widgets.children[1].value = f"Width: {new_width} pixels"
        self.right_widgets.children[2].value = f"Height: {new_height} pixels"
    ...
    def select_bin_parameter(self):
        ...
        self.bin_width_para = widgets.Dropdown(
        ...
        self.bin_height_para = widgets.Dropdown(
            options=options_list,
            value="2",
            description="height:",
            continuous_update=False,
        ...
        full_widget = widgets.HBox([left_widgets, center_widgets, self.right_widgets])
