...
# Form implementation generated from reading ui file '/Users/j35/git/python_notebooks/notebooks/ui/ui_panoramic_stitching.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.up_up_button.setStyleSheet("border: None")
        ...
        self.up_button.setStyleSheet("border: None")
        ...
        self.down_down_button.setStyleSheet("border: None")
        ...
        self.single_arrow_motion_value = QtWidgets.QSpinBox(self.tab_2)
        self.single_arrow_motion_value.setMinimum(1)
        self.single_arrow_motion_value.setMaximum(10)
        self.single_arrow_motion_value.setObjectName("single_arrow_motion_value")
        self.horizontalLayout_4.addWidget(self.single_arrow_motion_value)
        ...
        self.double_arrow_motion_value = QtWidgets.QSpinBox(self.tab_2)
        self.double_arrow_motion_value.setMinimum(5)
        self.double_arrow_motion_value.setMaximum(100)
        self.double_arrow_motion_value.setObjectName("double_arrow_motion_value")
        self.horizontalLayout_4.addWidget(self.double_arrow_motion_value)
        ...
        self.left_left_button.released.connect(MainWindow.left_left_button_released) # type: ignore
        self.right_button.pressed.connect(MainWindow.right_button_pressed) # type: ignore
        self.right_button.released.connect(MainWindow.right_button_released) # type: ignore
        self.right_right_button.pressed.connect(MainWindow.right_right_button_pressed) # type: ignore
        self.right_right_button.released.connect(MainWindow.right_right_button_released) # type: ignore
        self.up_button.pressed.connect(MainWindow.up_button_pressed) # type: ignore
        self.up_button.released.connect(MainWindow.up_button_released) # type: ignore
        self.down_button.pressed.connect(MainWindow.down_button_pressed) # type: ignore
        self.down_button.released.connect(MainWindow.down_button_released) # type: ignore
        self.up_up_button.pressed.connect(MainWindow.up_up_button_pressed) # type: ignore
        self.up_up_button.released.connect(MainWindow.up_up_button_released) # type: ignore
        self.down_down_button.pressed.connect(MainWindow.down_down_button_pressed) # type: ignore
        self.down_down_button.released.connect(MainWindow.down_down_button_released) # type: ignore
