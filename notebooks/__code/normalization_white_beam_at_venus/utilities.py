...
from __code._utilities.nexus import extract_acquisition_time_from_nexus, extract_proton_charge_from_nexus, retrieve_file_path_from_nexus
...
def extract_metadata(run_number=None, nexus_path=None, ipts_path=None, instrument=None) -> dict:
        """
        ...
        nexus_path, file_path = retrieve_file_path_from_nexus(nexus_folder_path=Path(nexus_path), 
