...
class Initialization:
    ...
    def widgets(self):
        ...
        _row = 0
        for _high_res_file, _low_res_file in zip(
    ...
    def matplotlib(self):
        ...
        self.parent.horizontal_profile_plot = _matplotlib(
            parent=self.parent, widget=self.parent.ui.horizontal_profile_widget
        )
        self.parent.vertical_profile_plot = _matplotlib(
            parent=self.parent, widget=self.parent.ui.vertical_profile_widget
        )
