...
class Deal:
    ...
    def select_input_folder(self):
        self.input_folder_ui = fileselector.FileSelectorPanel(
            instruction="Select Folder with All Images to Deal ...",
    ...
    def deal(self, output_folder):
        ...
        display(
            HTML(
                "<span>Number of images per folder: "
                + str(result_dict["nbr_images_per_folder"])
                + "<br>"
                + "Number of folders: "
                + str(result_dict["nbr_folders"])
                + "</span>"
            )
        )
    ...
    def __split(self, list_images=[]):
        ...
        return {
            "output_folder_dict": output_folder_dict,
    ...
    def __deal(
        ...
        box1 = widgets.HBox(
            [
                widgets.Label("images progress:", layout=widgets.Layout(width="30%")),
        ...
        box2 = widgets.HBox(
            [
                widgets.Label("folder progress:", layout=widgets.Layout(width="30%")),
