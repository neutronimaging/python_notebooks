...
class EventHandler:
    ...
    def use_excel_file_clicked(self, state):
        ...
        o_file = FileFolderBrowser(working_dir=self.parent.output_folder, next_function=self.load_excel_file)
        o_file.select_images(
            instruction="Select Excel file ...", multiple_flag=False, filters={"excel": "*.xls"}, default_filter="excel"
        )
