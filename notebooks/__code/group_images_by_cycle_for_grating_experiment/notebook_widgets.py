...
from __code.group_images_by_cycle_for_grating_experiment.event_handler import (
    EventHandler,
)
...
class NotebookWidgets:
    ...
    def select_metadata_to_use_for_sorting(self):
        ...
        self.parent.search_outer_field.observe(
            o_event.search_metadata_outer_edited, names="value"
        )
        ...
        result2 = widgets.HBox(
            [
                widgets.HTML(
                    "<u>Metadata Selected</u>:", layout=widgets.Layout(width="200px")
                ),
                widgets.Label(
                    metadata_outer_value, layout=widgets.Layout(width="100%")
                ),
            ]
        )
        ...
        self.parent.list_metadata_outer.observe(
            o_event.metadata_outer_selection_changed, names="value"
        )
        ...
        self.parent.search_inner_field.observe(
            o_event.search_metadata_inner_edited, names="value"
        )
        ...
        result1 = widgets.HBox(
            [
                ...
                widgets.Label(
                    metadata_inner_value, layout=widgets.Layout(width="100%")
                ),
            ]
        )
        ...
        self.parent.list_metadata_inner.observe(
            o_event.metadata_inner_selection_changed, names="value"
        )
        ...
        switch_layout = widgets.VBox(
            ...
            layout=widgets.Layout(
                height="400px", display="center", justify_content="space-around"
            ),
        )
    ...
    def display_groups(self):
        ...
        vbox_left = widgets.VBox(
            [
                ...
                widgets.Select(
                    options=group_label,
                    layout=widgets.Layout(width="150px", height="300px"),
                ),
            ]
        )
        ...
        vbox_center = widgets.VBox(
            [
                ...
                widgets.Select(
                    options=o_get.list_of_files_basename_only(0),
        ...
        o_event.list_of_files_changed(
            value={"new": o_get.list_of_files_basename_only(0)[0]}
        )
        ...
        bottom_hbox = widgets.HBox(
            [
                widgets.HTML(
                    "<b>Images are in</b>:", layout=widgets.Layout(width="150px")
                ),
                widgets.Label(
                    self.parent.data_path, layout=widgets.Layout(width="90%")
                ),
            ]
        )
    ...
    def generate_angel_configuration_file(self):
        ...
        hori_box = widgets.HBox(
            [load_previous_excel_ui, create_new_excel_ui], layout=hori_layout
        )
        display(hori_box)
