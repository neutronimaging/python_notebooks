...
class MathImages:
    ...
    def check_operation(self):
        ...
        display(
            HTML(
                '<span style="font-size: 20px; color:blue">You are about to '
                + math
                + " "
    ...
    def select_output_folder(self):
        self.output_folder_widget = fileselector.FileSelectorPanel(
            instruction="select where to create the " + "new images ...",
            start_dir=self.working_dir,
    ...
    def do_the_math(self, output_folder):
        ...
        new_output_folder = self.make_new_output_folder(
            input_folder=input_folder, output_folder=output_folder, math=math
        )
