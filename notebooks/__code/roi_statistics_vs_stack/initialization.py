...
class Initialization:
    ...
    def table(self):
        ...
        for _row in np.arange(len(self.parent.list_of_images)):
            ...
            list_column_index = [
                StatisticsColumnIndex.min,
                StatisticsColumnIndex.max,
                StatisticsColumnIndex.mean,
                StatisticsColumnIndex.median,
                StatisticsColumnIndex.std,
            ]
            for _col in list_column_index:
                o_table.insert_item(row=_row, column=_col, value="N/A", editable=False)
