...
class DetectionDiagnostics:
    edges_x: np.ndarray | None = None
    edges_y: np.ndarray | None = None
    edges_mag: np.ndarray | None = None
    horizontal_profile_smooth: np.ndarray | None = None
    peaks: np.ndarray | None = None
    edge_threshold: float | None = None
    vertical_edge_profile: np.ndarray | None = None
    vertical_edge_count: np.ndarray | None = None
...
) -> tuple[CylinderGeometry, DetectionDiagnostics | None]:
    """
...
def display_edges(
    geometry: CylinderGeometry, diagnostics: DetectionDiagnostics | None = None
):
...
def estimate_mu(
    ...
    *,
    cfg: MuEstimationConfig | None = None,
) -> np.ndarray:
    """
...
def visualize_correction_for_white_beam(
    ...
    mask_yx: np.ndarray,
    *,
    lambda_indices: Sequence[int] | None = None,
    figsize: tuple[int, int] = (14, 8),
) -> None:
    """
...
def analyze_hyperspectral_comparison(
    ...
    T_yxl_after: np.ndarray | None = None,
    *,
    ...
    min_positive_val: float | None = None,
) -> dict[str, Any]:
    """
