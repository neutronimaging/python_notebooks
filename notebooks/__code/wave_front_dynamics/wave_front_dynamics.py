...
class WaveFrontDynamics:
    ...
    def load_data(self):
        ...
        self.input_ascii_file_type = self.determine_input_ascii_file_type(list_of_ascii_files[0])
...
class WaveFrontDynamicsUI(QMainWindow):
    ...
    def __init__(self, parent=None, working_dir="./", wave_front_dynamics=None):
        ...
        self.input_ascii_file_type = wave_front_dynamics.input_ascii_file_type  # linear or radial profile

        if self.input_ascii_file_type == InputASCIIType.radial_profile:
