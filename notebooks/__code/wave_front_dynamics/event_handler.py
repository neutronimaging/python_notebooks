...
class EventHandler(Parent):
    ...
    def update_prepare_data_plot(self):
        ...
        data = self.parent.list_of_data[file_index]
        data = Algorithms.bin_data(data=data, bin_size=bin_size, bin_type=bin_type)

        self.parent.ui.prepare_data_plot.axes.plot(data)
