...
class SuperUser:
    ...
    def launch_ui(self):
        ...
        self.remove_entry = widgets.Button(
    ...
    def save_button_clicked(self, value):
        ...
        percentage_roi_selection = self.percentage_roi_value.value / 100.0
        ...
        make_ascii_file_from_string(text=ascii_after_formatted, filename=CONFIG_FILE)
