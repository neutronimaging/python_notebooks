...
class SelectionTab:
    ...
    def update_selection_profile_plot(self):
        ...
        self.parent.roi_selection_dict = {"x0": x0, "y0": y0, "x1": x1, "y1": y1}
    ...
    def update_bin_size_widgets(self):
        ...
        if current_axis_name == "tof":
            ...
            bin_size_value = f"{bin_size_value:2f}"
    ...
    def calculate_bin_size_in_all_units(self):
        ...
        if current_axis_name == "index":
            ...
            bin_index = find_nearest_index(array=lambda_array, value=current_value)
    ...
    def update_profile_of_bin_slider_widget(self):
        ...
        for _index, _key in enumerate(fitting_input_dictionary["rois"].keys()):
            dict_rois_imported[nbr_key - 1 - _index] = {
                "width": fitting_input_dictionary["rois"][_key]["width"],
    ...
    def calculate_big_table(self):
        ...
        for _row in np.arange(nbr_bin):
            for _col in np.arange(_row, nbr_bin):
                ...
                _item = o_table.insert_item_with_float(
                    row=_row, column=_col, float_value=diff_from_1, format_str="{:.4f}"
                )
        ...
        self.parent.optimum_bin_ratio = {
            "bin_number_1": row_and_column_of_max_ratio_value["row"][0],
    ...
    def get_lambda_index_range(bin_index=None, list_bin_positions=None):
        return SelectionTab.get_range_for_given_key(
            key="lambda", index=bin_index, list_bin_positions=list_bin_positions
        )
    ...
    def fill_summary_table(self, bin_index_1=None, bin_index_2=None):
        ...
        # file index
        (from_file_index, to_file_index) = SelectionTab.get_file_index_range(
    ...
    def initialize_table(self, nbr_bin=0):
        ...
        for bin_index in np.arange(nbr_bin):
            ...
            list_row_col_names.append(f"Bin #{bin_index}")
    ...
    def export_selected_image(self):
        ...
        if export_file_tuple[0]:
            ...
            o_norm.export(folder=folder_where_to_save, data_type="sample")
