...
from qtpy.QtWidgets import QFileDialog, QDialog, QMainWindow, QApplication
...
from __code.registration.registration_marker import RegistrationMarkersLauncher, RegistrationMarkers
