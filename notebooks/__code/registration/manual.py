...
class Manual(QMainWindow):
    ...
    button_size = {
        ...
        "rotate": {"width": 100, "height": 200},
        "small_rotate": {"width": 50, "height": 100},
    }
    ...
    def modified_selected_images(self, motion=None, rotation=0.0):
        ...
        for _row in list_row_selected:
            ...
            if not rotation == 0:  # column 3
                ...
                self.parent.ui.tableWidget.item(_row, 3).setText(f"{_new_value:.2f}")
    ...
    def small_rotate_left_button_clicked(self):
        self.modified_selected_images(rotation=0.1)
