from __code.combine_images_without_outliers.combine_images import CombineImagesAlgorithm
import pytest
import numpy as np
...
class TestCombineImagesWithOutliners:
	...
	def test_mean_without_outliers_4_arrays(self):
		...
		mean_array_calculated = CombineImagesAlgorithm.mean_without_outliers(list_array=[array1, array2, array3, array4])
